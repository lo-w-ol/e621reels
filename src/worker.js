...
<html lang="en">
  ...
  <body>
    <header class="global-header"><button class="global-menu-toggle" id="globalMenuBtn">☰</button><nav class="global-drawer" id="globalMenu"><a href="/" data-page-nav>Reels</a><a href="/photos" data-page-nav>Photos</a><a href="/about" data-page-nav>About</a></nav></header>
    <div class="shell">
